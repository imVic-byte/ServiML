...
<template>
  <div class="servi-yellow-font servi-blue p-2 rounded-xl mt-2 flex flex-col gap-2">
    ...
    <button 
      @click="activarCamara"
      type="button"
      class="w-full servi-yellow servi-grey-font text-white p-4 rounded-xl shadow-lg flex items-center justify-center gap-3 transition-transform transform active:scale-95"
    >
    ...
    <button @click="guardarFotos" :disabled="!tieneFotos" class="w-full text-lg font-bold servi-yellow servi-grey-font text-white p-4 rounded-xl shadow-lg flex items-center justify-center gap-3 transition-transform transform active:scale-95">
      Guardar
    </button>
    <input 
      ref="inputCamara"
