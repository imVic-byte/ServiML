...
const fechaHoyCorta = new Date().toLocaleDateString('es-CL', { year: 'numeric', month: 'numeric', day: 'numeric', hour: 'numeric', minute: 'numeric' })
const diaSemana = new Date().getDay()
const esFinDeSemana = computed(() => diaSemana === 0 || diaSemana === 6)

export { fechaInicioSemana, fechaFinSemana, fechaHoy, fechaHoyCorta, diaSemana, esFinDeSemana }
