        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div v-else class="md:hidden p-3 space-y-3">
                <div v-for="gasto in detalles" :key="gasto.id" class="p-3 rounded-lg border border-gray-100">
                  <div class="flex justify-between items-start mb-2">
                    <div>
                      <p class="font-medium servi-grey-font text-sm">{{ gasto.descripcion }}</p>
                  ...
                  <div class="flex justify-between items-center mt-2 pt-2 border-t border-gray-100">
                    <span class="font-bold servi-grey-font">{{ formatearDinero(gasto.monto) }}</span>
                  </div>
                </div>
              </div>
          ...
          <div class="lg:col-span-1 order-first lg:order-none">
            <div class="servi-adapt-bg rounded-lg shadow-lg border-t-4 border-yellow-500 p-4 md:p-6 lg:sticky lg:top-6">
              <h2 class="text-lg md:text-xl font-bold mb-4 md:mb-6 servi-grey-font">Resumen Financiero</h2>
