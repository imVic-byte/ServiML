    ...
    <div class="mx-auto p-4 max-w-5xl pb-28">
        ...
        <div class="flex flex-col lg:flex-row gap-6 mt-6">
                        ...
                        <div>
                            ...
                            <div class="space-y-2 text-sm servi-grey-font">
                                <p class="flex flex-col">
                                    ...
                                    <span class="servi-grey-font">{{ camelCase(cotizacion.nombre) + ' ' + camelCase(cotizacion.apellido) || 'No registrado' }}</span>
                                </p>
                            </div>
                        </div>
            ...
            <div class="lg:w-1/3 space-y-6">
                ...
                <!-- Resumen Financiero -->
                <div v-if="cotizacion.detalle_cotizacion && cotizacion.detalle_cotizacion.length > 0" class="servi-blue rounded-xl shadow-sm border border-gray-100">
