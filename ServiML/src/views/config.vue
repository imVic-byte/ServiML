    ...
    <div class="container mx-auto px-6 mt-2 pb-15">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div @click="router.push('/finanzas')"
          ...
          <h3 class="text-lg font-bold servi-grey-font group-hover:text-green-700 mb-1">Finanzas Diarias</h3>
        ...
        <div @click="router.push('/gastos')"
          ...
          <h3 class="text-lg font-bold servi-grey-font group-hover:text-red-600 mb-1">Gastos Mensuales Fijos</h3>
