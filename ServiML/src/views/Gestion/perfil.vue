...
<template>
    ...
    <div class="max-w-4xl mx-auto p-4 space-y-6 pb-30">
        
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
            <div class="servi-blue p-6 flex justify-between items-center">
                <div class="flex items-center gap-4">
                    <div class="p-3 bg-white/10 rounded-full text-white">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="flex items-center gap-3 p-3 rounded-lg bg-gray-50">
                    ...
                    <div>
                        ...
                        <p class="text-gray-800 font-medium">{{ usuario?.email || 'No registrado' }}</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 p-3 rounded-lg bg-gray-50">
                    ...
                    <div>
                        <p class="text-xs text-gray-500 uppercase font-bold">Teléfono</p>
                        <p class="text-gray-800 font-medium">+56 {{ trabajador?.telefono || '--' }}</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 p-3 rounded-lg bg-gray-50">
                    ...
                    <div>
                        <p class="text-xs text-gray-500 uppercase font-bold">RUT</p>
                        <p class="text-gray-800 font-medium">{{ trabajador?.rut || 'No registrado' }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <div class="flex justify-between items-center mb-4">
                ...
                <button class="text-sm text-blue-600 font-semibold hover:underline flex items-center gap-1" @click="$router.push('/perfil/historial')">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex flex-col items-center justify-center text-center hover:shadow-md transition-shadow">
                    <div class="p-3 bg-green-100 text-green-600 rounded-full mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                    </div>
                    <span class="text-3xl font-bold text-gray-800">{{ otFinalizadas }}</span>
                    <span class="text-sm text-gray-500 font-medium">Finalizadas</span>
                </div>
                ...
                <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex flex-col items-center justify-center text-center hover:shadow-md transition-shadow">
                    ...
                    <span class="text-3xl font-bold text-gray-800">{{ otEnProceso }}</span>
                    <span class="text-sm text-gray-500 font-medium">En Proceso</span>
                </div>
                ...
                <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex flex-col items-center justify-center text-center hover:shadow-md transition-shadow">
                    ...
                    <span class="text-3xl font-bold text-gray-800">{{ otPendientes }}</span>
                    <span class="text-sm text-gray-500 font-medium">Pendientes</span>
                </div>
                ...
                <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex flex-col items-center justify-center text-center hover:shadow-md transition-shadow">
                    ...
                    <span class="text-3xl font-bold text-gray-800">{{ otCanceladas }}</span>
                    <span class="text-sm text-gray-500 font-medium">Canceladas</span>
                </div>
