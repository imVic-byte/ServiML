...
<template>
    <div class="w-full min-h-screen servi-white">
        ...
        <div class="servi-adapt-bg  rounded-xl shadow-sm overflow-hidden">
            <div class="servi-blue p-6 flex justify-between items-center">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white">{{ trabajador?.nombre || 'Usuario' }} {{ trabajador?.apellido || '' }}</h1>
        ...
        <div>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="servi-adapt-bg p-4 rounded-xl border border-gray-100 shadow-sm flex flex-col items-center justify-center text-center hover:shadow-md transition-shadow">
