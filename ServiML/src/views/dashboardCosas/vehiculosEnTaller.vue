  ...
  <volver />
      <div class="flex justify-between items-center mb-6">
        <div>
          ...
          <p class="text-sm servi-grey-font">{{ vehiculosEnTaller.length }} vehículo{{ vehiculosEnTaller.length !== 1 ? 's' : '' }} actualmente en taller</p>
        </div>
      </div>
          ...
          <div class="p-4">
            ...
            <div v-if="item.cliente" class="flex items-center gap-3 pt-3 border-t border-gray-100 mt-2">
              ...
              <button 
                ...
                class="servi-blue text-white px-4 py-2 rounded-xl text-xs font-black shadow-sm active:scale-95 transition-transform"
              >
                VER
              </button>
            </div>
