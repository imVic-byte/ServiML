    ...
    <div v-else class="max-w-7xl mx-auto px-4 py-8">
      <div class="servi-white card-shadow border border-gray-100 overflow-hidden mb-8">
        ...
        <div v-if="!esCompletada"
          ...
          <button @click="buscarOTsDisponibles" class="inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 font-extrabold shadow-sm
              servi-yellow servi-blue-font transition-all duration-200
          ...
          <button @click="abrirModalAbono" :disabled="!puedeAbonar"
            class="inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 font-extrabold shadow-sm
         servi-blue servi-yellow-font transition-all duration-200
         hover:opacity-95 hover:shadow-md hover:-translate-y-[1px]
         active:translate-y-0 active:shadow-sm
         disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:shadow-sm disabled:hover:translate-y-0 disabled:hover:opacity-40">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24"
              stroke="currentColor">
          ...
          <button v-if="deuda.estado === 'pendiente'" 
          @click="pedirConfirmacionCompletar" :disabled="!puedeCompletar"
          class="inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 font-extrabold shadow-sm
         servi-blue servi-yellow-font transition-all duration-200
         hover:opacity-95 hover:shadow-md hover:-translate-y-[1px]
         active:translate-y-0 active:shadow-sm cursor-not-allowed">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24"
              stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          <button @click="marcarGestionado" class="inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 font-extrabold shadow-sm
         servi-yellow servi-blue-font transition-all duration-200
         hover:opacity-95 hover:shadow-md hover:-translate-y-[1px]
         active:translate-y-0 active:shadow-sm
         ml-auto">
          ...
          <button @click="showConfig = !showConfig" class="inline-flex items-center gap-2 rounded-xl px-3 py-2 font-bold
         text-gray-600 transition-colors
         hover:bg-gray-100 hover:text-gray-900 active:bg-gray-200" title="Configurar recordatorio">
